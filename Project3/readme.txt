...
SET FOREIGN_KEY_CHECKS=1; to turn on foreign key FOREIGN_KEY_CHECKS 
TODO:
1) Finish step 3
2) add constraints to create tables?
3) for arbitrary primary keys like Pizza_id what data type should we use INT / CHAR etc
...
4) check to make sure create tables is working
